...
def main(argv=None):
    ...
    try:
        ...
        try:
            ...
            inputShapeFile=r"/home/selin/Desktop/real/ruhiira/ruhiira1300.shp"
            
            #outputDir = argv[2]
            outputDir=r"/home/selin/Desktop/real/ruhiira/ruhiira1300"
            #algorithm = argv[3]
            searchRadius = 6000
        ...
        numNodes=len(nodes)
        segments= generateSegments(nodes,searchRadius)
